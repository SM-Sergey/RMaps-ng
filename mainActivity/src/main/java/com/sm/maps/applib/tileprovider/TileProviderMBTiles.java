...
import com.sm.maps.applib.utils.MBTilesMapDatabase;
...
public class TileProviderMBTiles extends TileProviderFileBase {
	private ExecutorService mThreadPool = Executors.newSingleThreadExecutor(new SimpleThreadFactory("TileProviderMBTiles"));
	private MBTilesMapDatabase mUserMapDatabase;
	private String mMapID;
	private ProgressDialog mProgressDialog;

	public TileProviderMBTiles(Context ctx, final String filename, final String mapid, MapTileMemCache aTileCache, TileSource tileSource) throws SQLiteException, RException {
		...
		mUserMapDatabase = new MBTilesMapDatabase();
		mUserMapDatabase.setFile(filename);
		mMapID = mapid;
		
		final File file = new File(filename);
		Ut.d("TileProviderMBTiles: mapid = "+mapid);
		Ut.d("TileProviderMBTiles: filename = "+filename);
		Ut.d("TileProviderMBTiles: file.exists = "+file.exists());
		Ut.d("TileProviderMBTiles: getRMapsMapsDir = "+Ut.getRMapsMapsDir(ctx));
