...
public class MixedMapsPreference extends MMPreferenceActivity implements OnSharedPreferenceChangeListener {
				...
				do {
					...
					case 2: {
						...
						pref.setIntent(new Intent(this, CustomMapsPrefActivity.class)
							...
							.putExtra(BLANKTILE, json.optString(BLANKTILE))
							...
							.putExtra(MAXDNLD, json.optString(MAXDNLD))
							);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		if(menuInfo == null || menuInfo != null && ((AdapterView.AdapterContextMenuInfo) menuInfo).position == 0) {
	...
	public boolean onContextItemSelected(MenuItem item) {
		if(item.getItemId() == R.id.add_dualmap) {
			...
			editor.remove(PREF_MIXMAPS_+params[2]+"_blanktile");
