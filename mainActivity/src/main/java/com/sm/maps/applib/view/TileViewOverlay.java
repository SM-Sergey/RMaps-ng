...
public abstract class TileViewOverlay {
	...
	public int onLongPress(MotionEvent e, TileView openStreetMapView) {
		...
		// 1 - событие обработано, блокировать обработку в других оверлеях, НЕ блокировать вызов контекстного меню
		// 2 - событие обработано, блокировать обработку в других оверлеях и блокировать вызов контекстного меню
		return 0;
	}
